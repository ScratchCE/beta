...
const singleStep = () => {
  ...
  if (!steppingThread) {
    steppingThread = findNewSteppingThread(0); // End of VM step, emulate one frame of time passing.
...
class Redux extends _event_target__WEBPACK_IMPORTED_MODULE_3__["default"] {
  ...
  initialize() {
    if (!this._initialized) {
      _hooks__WEBPACK_IMPORTED_MODULE_4__["default"].appStateReducer = (action, next) => {
