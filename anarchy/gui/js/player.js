...
, {
  defaultMessage: "This project uses cloud variables. Scratch Community Edition uses its own cloud variable server independent of Scratch. Beware of impersonation as anyone can change their username to anything. {learnMore}",
...
/* harmony import */ var _reducers_tw__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../reducers/tw */ "./src/reducers/tw.js");
const _excluded = ["intl", "projectId", "onSetAuthor", "onSetDescription", "onSetProjectTitle"];
...
const TWProjectMetaFetcherHOC = function TWProjectMetaFetcherHOC(WrappedComponent) {
  class ProjectMetaFetcherComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
    ...
    componentDidUpdate() {
      ...
      this.props.onSetProjectTitle(this.props.intl.formatMessage(messages.defaultProjectTitleWithId, {
        id: projectId.toString()
      }));
      this.props.onSetAuthor('', '');
      this.props.onSetDescription('', ''); // Don't try to load metadata for empty projects.
  ...
  const mapDispatchToProps = dispatch => ({
    onSetAuthor: (username, thumbnail) => dispatch(Object(_reducers_tw__WEBPACK_IMPORTED_MODULE_6__["setAuthor"])({
      username,
      thumbnail
    })),
    onSetDescription: (instructions, credits) => dispatch(Object(_reducers_tw__WEBPACK_IMPORTED_MODULE_6__["setDescription"])({
      instructions,
      credits
    })),
    onSetProjectTitle: title => dispatch(Object(_reducers_project_title__WEBPACK_IMPORTED_MODULE_5__["setProjectTitle"])(title))
  });

  return Object(react_intl__WEBPACK_IMPORTED_MODULE_4__["injectIntl"])(Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStateToProps, mapDispatchToProps)(ProjectMetaFetcherComponent));
};
...
, {
  ...
  href: "https://discord.gg/4kypmtHck9"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"], {
  ...
  href: "https://github.com/ScratchCE/"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"], {
...
class Interface extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  handleUpdateProjectTitle(title, isDefault) {
    if (isDefault || !title) {
      ...
      document.title = "".concat(title, " - Scratch Community Edition");
    }
  }
